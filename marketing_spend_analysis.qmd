...
clean_customer_data <- raw_customer_data %>%
    ...
    # Drop notes and signup_date columns
    select(-notes, -signup_date)
```
...
#| tbl-cap: "Summary statistics of numeric variables (marketing spend, visits, purchase amount) in the dataset"
